package com.stackstitch.restaurantlisting;
...
public class ExcelProcessor {
    public static void main(String[] args) {
        String filePath = "D:/Projects/Spring Boot/restaurantlisting/ddd.xlsx";
    ...
    public static void processExcel(String filePath) {
        try (FileInputStream fis = new FileInputStream(new File(filePath));
            ...
            Row headerRow = sheet.getRow(2); // Get column names from row 2
